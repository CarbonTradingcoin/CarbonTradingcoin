...
#ifndef H_CARBONEMISSIONTRADECOIN_SCRIPT
#define H_CARBONEMISSIONTRADECOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CCarbonemissiontradecoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Carbonemissiontradecoin always counted CHECKMULTISIGs
