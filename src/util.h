...
#ifndef CARBONEMISSIONTRADECOIN_UTIL_H
#define CARBONEMISSIONTRADECOIN_UTIL_H
...
static const int64 COIN = 100000000LL;
...
{
    std::string s = strprintf("carbonemissiontradecoin-%s", name);
