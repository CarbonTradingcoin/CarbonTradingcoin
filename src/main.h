...
#ifndef CARBONEMISSIONTRADECOIN_MAIN_H
#define CARBONEMISSIONTRADECOIN_MAIN_H
...
static const unsigned int MAX_STANDARD_TX_SIZE = MAX_BLOCK_SIZE/5;
...
static const int64 DUST_SOFT_LIMIT = 10000; // 0.0001 VTC
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 VTC mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = (92000000000LL) * COIN;//93 billion
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
/** Coinbase transaction outputs can only be spent after this number of new blocks (network rule) */
static const int COINBASE_MATURITY = 220;// mature after 240 blocks
...
extern uint256 hashMerkleRootBlock;
...
public:
    ...
    */
    ...
    /** Amount of carbonemissiontradecoins spent by this transaction.
    ...
    /** Amount of carbonemissiontradecoins coming in to this transaction
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 576 / 250; // Carbonemissiontradecoin: (1440) blocks found a day. Priority cutoff is 1 coin day / 250 bytes.
    }
 ...
 *               * 8358: compact amount representation for 60000000000 (600 CT)
 ...
 *             * 86ef97d579: compact amount representation for 234925952 (2.35 CT)
 *             * 00: special txout type pay-to-pubkey-hash
 *             * 61b01caab50f1b8e9c50a5057eb43c2d9563a4ee: address uint160
 *  - vout[16]: bbd123008c988f1a4a4de2161e0f50aac7f17e7f9555caa4
 *              * bbd123: compact amount representation for 110397 (0.001 CT)
 *              * 00: special txout type pay-to-pubkey-hash
