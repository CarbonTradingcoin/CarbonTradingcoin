...
{
    BOOST_CHECK(TestSplitHost("www.carbonemissiontradecoin.org", "www.carbonemissiontradecoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.carbonemissiontradecoin.org]", "www.carbonemissiontradecoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.carbonemissiontradecoin.org:80", "www.carbonemissiontradecoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.carbonemissiontradecoin.org]:80", "www.carbonemissiontradecoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:57177", "127.0.0.1", 57177));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:57177", "127.0.0.1", 57177));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:57177", "::ffff:127.0.0.1", 57177));
    BOOST_CHECK(TestSplitHost("[::]:57177", "::", 57177));
    BOOST_CHECK(TestSplitHost("::57177", "::57177", -1));
    BOOST_CHECK(TestSplitHost(":57177", "", 57177));
    BOOST_CHECK(TestSplitHost("[]:57177", "", 57177));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:47177", "127.0.0.1:47177"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:47177", "[::]:47177"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
