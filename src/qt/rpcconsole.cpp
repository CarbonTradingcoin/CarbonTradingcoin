...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the Carbonemissiontradecoin RPC console.") + "<br>" +
...
void RPCConsole::setNumBlocks(int count, int countOfPeers)
{
    ...
    if(abs(countOfPeers-count)<100)
    ui->totalBlocks->setText(countOfPeers == 0 ? tr("N/A") : QString::number(countOfPeers));
    else ui->totalBlocks->setText(countOfPeers == 0 ? tr("N/A") : QString::number(count));
    if(clientModel)
