    ...
    QSplashScreen(pixmap, f)
{
    ...
    //QString copyrightText   = QChar(0xA9)+QString(" 2013-%1 ").arg(COPYRIGHT_YEAR) + QString(tr("CT DEV"));
    QString copyrightText   = QChar(0xA9)+QString(" 2014-%1 ").arg("") + QString(tr("CT DEV"));
