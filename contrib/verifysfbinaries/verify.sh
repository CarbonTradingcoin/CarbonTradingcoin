...
WORKINGDIR="/tmp/carbonemissiontradecoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/carbonemissiontradecoin/Carbonemissiontradecoin/carbonemissiontradecoin-0.8.99/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/carbonemissiontradecoin/Carbonemissiontradecoin/"
VERSIONPREFIX="carbonemissiontradecoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'carbonemissiontradecoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[carbonemissiontradecoin-]<version>-[rc[0-9]] (example: carbonemissiontradecoin-0.7.1-rc1)"
   echo "wget output:"
